...
public class TransactionControllerIT {
    ...
    @Test
    public void processTransactionShouldReturnUnprocessableEntityWhenCardholderNameIsBlank() throws Exception {
        TransactionDTO transactionDTO = Factory.createTransactionDTO();
        transactionDTO.setCardholderName(null);
        String jsonBody = objectMapper.writeValueAsString(transactionDTO);
    ...
    @Test
    public void processTransactionShouldReturnUnprocessableEntityWhenCardholderNameHasMoreThan255Characters() throws Exception {
        TransactionDTO transactionDTO = Factory.createTransactionDTO();
        transactionDTO.setCardholderName("Lorem ipsum dolor sit amet. Aut eligendi repellat aut nemo consequatur 33 rerum accusantium est mollitia pariatur a obcaecati sint quo temporibus doloremque. Non quis praesentium et veniam dolor in quos minus sit dolores obcaecati non nihil quae. Et omnis molestiae in modi delectus ab asperiores dignissimos.");
        String jsonBody = objectMapper.writeValueAsString(transactionDTO);
    ...
    @Test
    public void processTransactionShouldReturnUnprocessableEntityWhenCardExpirationDateIsBlank() throws Exception {
        TransactionDTO transactionDTO = Factory.createTransactionDTO();
        transactionDTO.setCardExpirationDate(null);
        String jsonBody = objectMapper.writeValueAsString(transactionDTO);
    ...
    @Test
    public void processTransactionShouldReturnUnprocessableEntityWhenCardExpirationDateIsInvalid() throws Exception {
        TransactionDTO transactionDTO = Factory.createTransactionDTO();
        transactionDTO.setCardExpirationDate("08/2020");
        String jsonBody = objectMapper.writeValueAsString(transactionDTO);
    ...
    @Test
    public void processTransactionShouldReturnUnprocessableEntityWhenCvvIsNull() throws Exception {
        TransactionDTO transactionDTO = Factory.createTransactionDTO();
    ...
    @Test
    public void processTransactionShouldReturnUnprocessableEntityWhenCvvIsOutOfDesiredFormat() throws Exception {
        TransactionDTO transactionDTO = Factory.createTransactionDTO();
        transactionDTO.setCvv("18754");
        String jsonBody = objectMapper.writeValueAsString(transactionDTO);
